...
const handleClose = () => {
  ...
  const handleAddCategory = async() => {
    ...
    try {
      await fitnessService.add1(data);
      toast.success("Banner created successfully!");
      navigate(`${process.env.PUBLIC_URL}/banner/fitness_banner`);
    } catch (error) {
    ...
    >
      ...
      <ModalBody>
        <Form className="theme-form">
          ...
          <FormGroup>
            <Label className="col-sm-3 col-form-label">Upload Banner</Label>
            <Col sm="9">
              <Input
                className="form-control"
                type="file"
      ...
      <ModalFooter>
        <Btn attrBtn={{ color: "secondary", onClick: handleClose }}>
          Close
        </Btn>
