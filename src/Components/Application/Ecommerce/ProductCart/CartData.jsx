                  ...
                  <tbody>
                    ...
                    <tr>
                      <td className="text-end" colSpan="5">
                        <Link to={`${process.env.PUBLIC_URL}/app/ecommerce/product`} className="btn btn-secondary cart-btn-transform">
                          continue shopping
                        </Link>
                      </td>
                      <td>
                        <Link className="btn btn-success cart-btn-transform" to={`${process.env.PUBLIC_URL}/app/ecommerce/checkout`}>
                          check out
                        </Link>
                      </td>
                    </tr>
