                ...
                <Col lg='6' className='product-details text-start'>
                  ...
                  <div className='product-qnty'>
                    ...
                    <div className='addcart-btn'>
                      <Link to={`${process.env.PUBLIC_URL}/app/ecommerce/cart`} className='btn btn-primary me-3' onClick={() => AddToCarts(singleProduct, quantity)}>
                        {AddToCart}
                      </Link>
                      <Link to={`${process.env.PUBLIC_URL}/app/ecommerce/product-page/${singleProduct.id}`} className='btn btn-primary'>
                        {ViewDetails}
                      </Link>
                    </div>
                  </div>
