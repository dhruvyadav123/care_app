      ...
      <div className={`cart-dropdown onhover-show-div ${cartDropdown ? 'active' : ''}`}>
        ...
        <ul>
          ...
          <li className='text-center'>
            <Link to={`${process.env.PUBLIC_URL}/app/ecommerce/cart`} className='d-block mb-3 view-cart f-w-700'>
              {GOTOYOURCART}
            </Link>
            <Link to={`${process.env.PUBLIC_URL}/app/ecommerce/checkout`} className='btn btn-primary view-checkout'>
              {CheckOut}
            </Link>
          </li>
        </ul>
